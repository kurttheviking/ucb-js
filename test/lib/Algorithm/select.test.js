...
describe('Algorithm#select', () => {
  ...
  it('if there is one empty arm, returns that empty arm', () => {
    ...
    Promise.all(trials.map(() => alg.select())).then((selections) => {
  ...
  it('randomly selects an empty arm when more than one', () => {
